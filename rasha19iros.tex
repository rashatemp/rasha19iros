...
network is re-trained. To compute the gradients, corresponding ground
truth data is needed. In our approach, we treat the result of unsupervised  segmentation as ground truth.  We
