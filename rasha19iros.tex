...
\\
{\parbox{\textwidth}{\centering  Submission ID}
}
}
...
To compute the measures explained in the following sections, we use what we refer to in the text as pseudo-ground truth. These are foreground masks generated by clustering with very weak supervision. We detail this further in the subsequent section.
